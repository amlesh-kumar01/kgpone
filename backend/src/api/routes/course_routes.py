...
def create_department(dept_in: DepartmentCreate, service: CourseService = Depends(get_course_service)):
...
def list_departments(service: CourseService = Depends(get_course_service)):
...
def get_department(dept_id: UUID, service: CourseService = Depends(get_course_service)):
...
def create_course(course_in: CourseCreate, service: CourseService = Depends(get_course_service)):
...
def list_courses(department_id: UUID | None = None, service: CourseService = Depends(get_course_service)):
...
def create_offering(offering_in: CourseOfferingCreate, service: CourseService = Depends(get_course_service)):
...
def list_offerings(course_id: UUID, service: CourseService = Depends(get_course_service)):
...
def add_faculty_to_offering(faculty_in: FacultyInfoCreate, service: CourseService = Depends(get_course_service)):
