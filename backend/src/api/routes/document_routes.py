...
def upload_document(doc_in: DocumentCreate, service: DocumentService = Depends(get_document_service)):
...
def list_documents_for_offering(offering_id: UUID, service: DocumentService = Depends(get_document_service)):
...
def update_document(document_id: UUID, doc_update: DocumentUpdate, service: DocumentService = Depends(get_document_service)):
